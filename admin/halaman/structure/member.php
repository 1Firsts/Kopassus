        ...
        <section class="section">
          <div class="section-header">
            <div class="row">
              ...
              <form method="post" enctype="multipart/form-data" action="../../halaman/upload/profile/pmember.php">
                ...
                <div class="form-group" style="margin-right: 0px;margin-left: 185px;padding-top: 100px;">
                  ...
                  <div class="form-group">
                    <img class="" src="../../halaman/upload/profile/uploadmember/<?= $data['member'] ?>" alt="image" height="100px" width="100px">
                      <div class="fallback">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="nicke" value="<?php echo $data['nicke'] ?>" class="form-control">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="selectgroup w-100">
                      <label class="selectgroup-item">
                        <input type="radio" name="rle" value="ion-knife" class="selectgroup-input" <?=$data['rle']=="ion-knife" ? "checked" : ""?>>
                      ...
                      <label class="selectgroup-item">
                        <input type="radio" name="rle" value="ion-android-favorite" class="selectgroup-input" <?=$data['rle']=="ion-android-favorite" ? "checked" : ""?>>
                      ...
                      <label class="selectgroup-item">
                        <input type="radio" name="rle" value="ion-android-hand" class="selectgroup-input" <?=$data['rle']=="ion-android-hand" ? "checked" : ""?>>
                ...
                <div class="text-center" style="margin-left: 595px;">
                  ...
                  <a href="officer.php?id=<?= $data['id']?>" class="btn btn-primary">Next</a>
                </div>
              </form>
            </div>
