        ...
        <section class="section">
          <div class="section-header">
            <div class="row">
              ...
              <form method="post" enctype="multipart/form-data" action="../../halaman/upload/profile/precruit.php">
                ...
                <div class="form-group" style="margin-right: 0px;margin-left: 185px;padding-top: 100px;">
                  ...
                  <div class="form-group">
                    <img class="" src="../../halaman/upload/profile/uploadrecruit/<?= $data['Recruit'] ?>" alt="image" height="100px" width="100px">
                      <div class="fallback">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="nickit" value="<?php echo $data['nickit'] ?>" class="form-control">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="selectgroup w-100">
                      <label class="selectgroup-item">
                        <input type="radio" name="rlit" value="ion-knife" class="selectgroup-input" <?=$data['rlit']=="ion-knife" ? "checked" : ""?>>
                      ...
                      <label class="selectgroup-item">
                        <input type="radio" name="rlit" value="ion-android-favorite" class="selectgroup-input" <?=$data['rlit']=="ion-android-favorite" ? "checked" : ""?>>
                      ...
                      <label class="selectgroup-item">
                        <input type="radio" name="rlit" value="ion-android-hand" class="selectgroup-input" <?=$data['rlit']=="ion-android-hand" ? "checked" : ""?>>
                ...
                <div class="text-center" style="margin-left: 595px;">
                  ...
                  <a href="thhand.php?id=<?= $data['id']?>" class="btn btn-primary">Next</a>
                </div>
              </form>
            </div>
