        ...
        <section class="section">
          <div class="section-header">
            <div class="row">
              ...
              <form method="post" enctype="multipart/form-data" action="../../halaman/upload/profile/pthhand.php">
                ...
                <div class="form-group" style="margin-right: 0px;margin-left: 185px;padding-top: 100px;">
                  ...
                  <div class="form-group">
                    <img class="" src="../../halaman/upload/profile/uploadthhand/<?= $data['th_hand'] ?>" alt="image" height="100px" width="100px">
                      <div class="fallback">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="nicknd" value="<?php echo $data['nicknd'] ?>" class="form-control">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="selectgroup w-100">
                      <label class="selectgroup-item">
                        <input type="radio" name="rlnd" value="ion-knife" class="selectgroup-input" <?=$data['rlnd']=="ion-knife" ? "checked" : ""?>>
                      ...
                      <label class="selectgroup-item">
                        <input type="radio" name="rlnd" value="ion-android-favorite" class="selectgroup-input" <?=$data['rlnd']=="ion-android-favorite" ? "checked" : ""?>>
                      ...
                      <label class="selectgroup-item">
                        <input type="radio" name="rlnd" value="ion-android-hand" class="selectgroup-input" <?=$data['rlnd']=="ion-android-hand" ? "checked" : ""?>>
                ...
                <div class="text-center" style="margin-left: 595px;">
                  ...
                  <a href="warmaster.php?id=<?= $data['id']?>" class="btn btn-primary">Next</a>
                </div>
              </form>
            </div>
